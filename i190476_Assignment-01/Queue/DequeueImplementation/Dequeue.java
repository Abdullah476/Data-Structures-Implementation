...
public class Dequeue{
	...
	public void addLeft(int data){
		...
		if(rightPointer==capacity-1){	//Cannot cover this condition every time when 
			if(leftPointer==0){			//you continuously addLeft or in mix with addRight
				return;					//first condition becomes true and function returns 
			}
			else{
				rightPointer=0;
	...
	public void addRight(int data){
		...
		if(leftPointer==0){					//Cannot cover this condition every time when 
			if(rightPointer==capacity-1){	//you continuously addLeft or in mix with addRight
				return;						//first condition becomes true and function returns
			}
			else{
